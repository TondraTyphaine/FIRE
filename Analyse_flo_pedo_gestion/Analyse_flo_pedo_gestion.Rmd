...
Le nombre d'horizon semble fortement et positivement corrélé à l'épaisseur de l'horizon T2.
L'épaisseur de l'horizon A semble négativement corrélée au pourcentage d'argile dans le sol.
Il en est de même entre l'horizon J et le pourcentage de sable.
A l'inverse, l'épaisseur de l'horizon J semble être positivement corrélé au pourcentage d'argile.
Enfin, le pourcentage de sable et le pourcentage de limons semblent être fortement et négativement corrélés.

## Pourcentage des types biologiques

Concernant le pourcentage des types biologiques, il semblerait que les pourcentagse des thérophytes et des hémicryptophytes soientt positivement et fortement corrélée.
De même pour les chaméphytes et les phanérophytes.
De fortes corrélations négatives sont notables entre le pourcentage de thérophytes et de chaméphytes, entre hémicryptophytes et chaméphytes/lianscents/phanérophytes.

## Toutes les variables

La fauche tardive est fortement et positivement corrélée avec le pourcentage de phanérophytes, la conservation de bois mort et la classification en zone ZNIEFF.
A l'inverse, cette variables est fortement et négativement corrélée avec le pourcentage d'hémicryptophytes.
s La conservation de bois mort est fortement et positivement corrélée à la classification en zone ZNIEFF, et corrélée plus modérément avec le pourcentage de phanérophytes et de chaméphytes.
Cette variables est négatvivement et fortement corrélée au pourcentage d'hémicryptophytes, et dans une moindre mesure au pourcentage de thérophytes et d'argile.

L'élagage est corrélée positivement et modérément à la conservation du bois mort, à la fauche tardive, à la classification en zone ZNIEFF et au pourcentage de lianescent.
A l'inverse, l'élagage est modérément et négativement corrélée à l'aménagement de structure de loisir.
