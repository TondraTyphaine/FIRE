...
La fauche tardive est fortement et positivement corrélée avec le pourcentage de phanérophytes, la conservation de bois mort et la classification en zone ZNIEFF. A l'inverse, cette variables est fortement et négativement corrélée avec le pourcentage d'hémicryptophytes.
s
La conservation de bois mort est fortement et positivement corrélée à la classification en zone ZNIEFF, et corrélée plus modérément avec le pourcentage de phanérophytes et de chaméphytes. Cette variables est négatvivement et fortement corrélée au pourcentage d'hémicryptophytes, et dans une moindre mesure au pourcentage de thérophytes et d'argile.

L'élagage est corrélée positivement et modérément à la conservation du bois mort, à la fauche tardive, à la classification en zone ZNIEFF et au pourcentage de lianescent. A l'inverse, l'élagage est modérément et négativement corrélée à l'aménagement de structure de loisir.

L'aménagement de structure de loisir est faiblement corrélée avec l'ensemble des autres variables.

La présence de panneaux, la coupe des arbres et la plantation d'arbre ont des corrélations nulles avec les autres variables, car elles ne présentent aucunes variations (que des 1 dans la variable).
...
#data$Mean_horizon_nb <- as.numeric(data$Mean_horizon_nb)
...
Le pourcentage d'argile, de thérophytes et d'hémichryptophytes sont fortement et négativement corrélés au premier axe de l'ACP. A l'inverse, le pourcentage de lianescent, de phanérophytes, de chaméphytes, la fauche tardive, la conservation de bois mort, l'élagage et la classification en zone ZNIEFF sont fortement et positivement corrélés au premier axe de l'ACP. Le nombre moyen d'horizon et l'épaisseur moyenne de l'horizon T3 sont fortement et négativement corrélés au second axe. L'épaisseur moyenne de l'horizon O, le pourcentage d'hélophyte et l'aménagement de structure de loisir sont fortement et positivement corrélés au second axe de l'ACP. L'épaisseur de l'horizon A et le pourcentage de sable sont également positivement corrélés à l'axe 2 mais de manière plus modérée.
...
Les individus DM.1, Be.1 et Be.3 sont très bien représentés dans l'ACP. En revanche, les individus Ri.1, Ri.2 et Ri.3 sont plus mal représentés.
...
Concernant les autres individus, leur regroupement est plus diffus. Les individus Be.1 et Ri.2 sont plutôt influencés par le pourcentage d'argile, de thérophytes et d'hémichryptophytes pour l'axe 1, et par les mêmes variables que les individus DM.1, DM.2 et DM.3 pour l'axe 2.
